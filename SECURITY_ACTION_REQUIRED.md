...
Ранее Telegram bot token был передан в переписке и поэтому считается скомпрометированным. Версия 2.0.3 не содержит его, но отзыв старого значения обязателен.
